<div class="post-news pt-52 xl:pt-48 pb-16 md:pb-32 xl:pb-60 overflow-hidden">
	<div class="st-grid">
        <div class="st-container st-container-grid">
            ...
            <div class="content-col col-span-2 md:col-span-6 xl:col-span-7 flex flex-col">
                ...
                <div class="col-span-2 md:col-span-6 xl:col-span-7 mb-7 xl:mb-0 xl:pr-14">
                    <div class="st-body-dates text-dark-blue mb-20"><?php the_content(); ?></div>
                </div>
            </div>
            <div class="sidebar-col col-span-2 md:col-span-6 xl:col-span-3">
