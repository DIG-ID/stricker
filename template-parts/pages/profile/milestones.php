    ...
    <div class="scroll-section relative h-[101vh]">
        <div class="panel w-[100vw] st-grid">
            <div class="col-span-2 md:col-span-6 xl:col-span-7 grid grid-cols-2 md:grid-cols-6 xl:grid-cols-7 gap-6 xl:gap-8 px-6 md:px-0 bg-dark-blue">
                ...
                <div class="absolute bottom-12 left-[40%] z-10">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/svg/section-arrow-right.svg" alt="arrow-right" title="arrow right" />
                </div>
            </div>

            <div class="col-span-2 md:col-span-6 xl:col-span-5 col-start-1 md:col-start-2 xl:col-start-8 grid grid-cols-2 md:grid-cols-6 xl:grid-cols-5 gap-6 xl:gap-8 px-6 md:px-0 bg-[#DFF4F7] pt-40 pb-36">
