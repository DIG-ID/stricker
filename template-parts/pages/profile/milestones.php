    ...
    <div class="scroll-section relative h-[101vh]">
        <div class="panel w-[100vw] md:w-[130vw] xl:w-[100vw] st-grid !px-0">
            <div class="col-span-1 md:col-span-4 xl:col-span-7 grid grid-cols-2 md:grid-cols-6 xl:grid-cols-7 gap-6 xl:gap-8 px-6 md:px-0 bg-dark-blue">
                ...
                <div class="absolute bottom-12 left-[35%] z-10 hidden md:block">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/svg/section-arrow-right.svg" alt="arrow-right" title="arrow right" />
                </div>
            </div>

            <div class="col-span-1 md:col-span-2 xl:col-span-5 col-start-2 md:col-start-5 xl:col-start-8 grid grid-cols-2 md:grid-cols-6 xl:grid-cols-5 gap-6 xl:gap-8 px-6 md:px-0 bg-[#DFF4F7] py-28">
        ...
        <div class="panel st-grid w-[100vw] md:w-[130vw] xl:w-[100vw] py-28 bg-[#DFF4F7]">
            ...
            <div class="col-span-1 md:col-span-2 xl:col-span-5 col-start-2 md:col-start-5 xl:col-start-7 relative">
                <?php 
                ...
                <?php endif;
                ?>
                <p class="st-subtitle-i mb-24 xl:mt-20 xl:ml-20 max-w-[374px]"><?php the_field( 'milestones_content_text_3' ); ?></p>
                <?php 
                $image = get_field( 'milestones_content_image_3-2' );
                if ( $image ) : ?>
                    <?php echo wp_get_attachment_image( $image, 'full', false, array( 'class' => 'w-full object-cover absolute max-w-[334px] top-[30%] -right-[20%]' ) ); ?>
                <?php endif;
                ?>
            </div>
        </div>
        ...
        <div class="panel st-grid w-[100vw] md:w-[130vw] xl:w-[100vw] py-28 bg-[#DFF4F7]">
            <div class="col-span-1 md:col-span-4 xl:col-span-4 col-start-1 md:col-start-1 xl:col-start-2">
                <p class="st-subtitle-i mb-24 max-w-[374px]"><?php the_field( 'milestones_content_text_4' ); ?></p>
                <?php 
                $image = get_field( 'milestones_content_image_4' );
                if ( $image ) : ?>
                    <?php echo wp_get_attachment_image( $image, 'full', false, array( 'class' => 'w-full object-cover ml-20' ) ); ?>
                <?php endif;
                ?>
            </div>
            <div class="col-span-1 md:col-span-2 xl:col-span-4 col-start-2 md:col-start-5 xl:col-start-8">
                <?php 
                ...
                <?php endif;
                ?>
                <p class="st-subtitle-i mb-24 xl:ml-40 mt-20 max-w-[420px]"><?php the_field( 'milestones_content_text_5' ); ?></p>
            </div>
        </div>

        <div class="panel st-grid w-[100vw] md:w-[130vw] xl:w-[100vw] py-28 bg-[#DFF4F7]">
            <div class="col-span-1 md:col-span-4 xl:col-span-4 grid grid-cols-1 md:grid-cols-4 xl:grid-cols-3 col-start-1 md:col-start-1 xl:col-start-2">
                <div class="col-span-1 md:col-span-4 xl:col-span-2 col-start-1 md:col-start-1 xl:col-start-2">
                    <p class="st-subtitle-i mb-24"><?php the_field( 'milestones_content_text_6' ); ?></p>
                </div>
                <div class="col-span-1 md:col-span-4 xl:col-span-2 col-start-1">
                    <?php 
                    $image = get_field( 'milestones_content_image_6-2' );
                    if ( $image ) : ?>
                        <?php echo wp_get_attachment_image( $image, 'full', false, array( 'class' => 'w-full object-cover max-w-[334px]' ) ); ?>
                    <?php endif;
                    ?>
                </div>
            </div>
            <div class="col-span-1 md:col-span-2 xl:col-span-5 col-start-2 md:col-start-5 xl:col-start-7">
                <?php 
        ...
        <div class="panel st-grid w-[100vw] md:w-[130vw] xl:w-[100vw] py-28 bg-[#DFF4F7]">
            <div class="col-span-1 md:col-span-4 xl:col-span-5 grid grid-cols-1 md:grid-cols-4 xl:grid-cols-5 col-start-1 md:col-start-1 xl:col-start-2">
                <div class="col-span-1 md:col-span-4 xl:col-span-3 col-start-1 md:col-start-1 xl:col-start-2">
            ...
            <div class="col-span-1 md:col-span-2 xl:col-span-4 col-start-2 md:col-start-5 xl:col-start-7 xl:-ml-32">
                <?php 
        ...
        <div class="panel st-grid w-[100vw] md:w-[150vw] xl:w-[100vw] py-28 bg-[#DFF4F7]">
            <div class="col-span-1 md:col-span-4 xl:col-span-3 flex items-center">
                <p class="st-subtitle-i mb-24"><?php the_field( 'milestones_content_text_8' ); ?></p>
            </div>
            <div class="col-span-1 md:col-span-2 xl:col-span-4 xl:max-w-[454px] col-start-2 md:col-start-5 xl:col-start-4">
                <?php 
