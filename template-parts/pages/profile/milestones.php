<section class="section-milestones relative bg-[#DFF4F7]">
    <div class="scroll-section relative h-[101vh]">
        <div class="panel w-[150vw] md:w-[150vw] xl:w-[100vw] st-grid !px-0">
            ...
            <div class="col-span-1 md:col-span-3 xl:col-span-5 col-start-2 md:col-start-4 xl:col-start-8 grid grid-cols-2 md:grid-cols-6 xl:grid-cols-5 gap-6 xl:gap-8 px-6 md:px-0 bg-[#DFF4F7] py-28">
                <div class="col-span-2 md:col-span-5 xl:col-span-3 z-10">
                <?php 
                ...
                <div class="col-span-2 md:col-span-4 xl:col-span-5 col-start-1 md:col-start-2 xl:col-start-2 xl:col-end-5 flex flex-col justify-end items-end">
        ...
        <div class="panel st-grid w-[150vw] md:w-[150vw] xl:w-[100vw] py-28 bg-[#DFF4F7]">
            ...
            <div class="col-span-1 md:col-span-3 xl:col-span-5 col-start-2 md:col-start-4 xl:col-start-7 relative px-12 xl:px-0">
                <?php 
        ...
        <div class="panel st-grid w-[150vw] md:w-[150vw] xl:w-[100vw] py-28 bg-[#DFF4F7]">
            <div class="col-span-1 md:col-span-3 xl:col-span-4 grid grid-cols-1 md:grid-cols-4 xl:grid-cols-3 col-start-1 md:col-start-1 xl:col-start-2 px-12 xl:px-0">
