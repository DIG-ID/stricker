...
<div class="swiper swiper-tour">
    <div class="swiper-wrapper gap-6 xl:gap-8 px-0">
        <?php for ($i = 0; $i < 12; $i++) : ?>
            <div class="swiper-slide flex flex-row justify-between min-w-[160px] sm:min-w-[100px] md:min-w-[265px]">
...
<section class="section-schedule bg-dark-blue pt-16 pb-12 xl:pt-44">
    <div class="st-grid">
        <div class="col-span-2 md:col-span-4 xl:col-span-9 col-start-1 md:col-start-2 xl:col-start-2 grid grid-cols-2 md:grid-cols-6 xl:grid-cols-9 px-4 md:px-0">
            <div class="col-span-6 xl:col-span-1 pt-14 items-center flex-col flex xl:block">
                <img class="xl:float-left w-[38px] md:w-[67px] pb-4 md:pb-7 xl:pb-0" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/svg/cup.svg" alt="tournament cup" title="tournament cup">
                <p class="tournament__side-title xl:float-left st-subtitle-big-regular !text-[28px] md:!text-[45px] text-blue xl:transform xl:-rotate-90"><?php esc_html_e( 'Turniere', 'stricker' ) ?></p>
            </div>
            <div class="col-span-6 xl:col-span-3">
                ...
                <div class="pt-1 md:pt-6 pb-8 md:pb-11 xl:border-b-2 border-blue xl:max-h-[196px]">
                <?php
                ...
                if ($tournament_found) :
                    ...
                    <a href="<?php echo $selected_tournament_link; ?>" target="_blank" class="st-subtitle-caps text-light-blue text-nowrap truncate-text underline !text-[18px] md:!text-[32px] min-h-[46px]"><?php echo $selected_tournament_title; ?></a><br>
                    <p class="st-subtitle text-blue text-nowrap truncate-text !text-[18px] md:!text-[32px]"><?php echo $selected_tournament_location; ?></p>
                <?php else : ?>
                    ...
                    <a class="st-subtitle-caps text-light-blue text-nowrap !text-[18px] md:!text-[32px] min-h-[46px]"><?php esc_html_e('Kein vorheriges Turnier', 'stricker'); ?></a>
            ...
            <div class="col-span-6 xl:col-span-2">
                ...
                <div class="pt-1 md:pt-6 pb-8 md:pb-16 xl:border-b-2 border-blue xl:max-h-[192px]">
                <?php
                $current_date = date('Ymd');
                $tournament_query = new WP_Query(array(
                    'post_type'      => 'tournament',
                ...
                if ($tournament_query->have_posts()) :
                    while ($tournament_query->have_posts()) :
                        ...
                        if ($start_date_Ymd && $end_date_Ymd && $start_date_Ymd <= $current_date && $end_date_Ymd >= $current_date) :
                            ...
                            ?>
                            <p class="st-body-dates text-blue !leading-[29px] md:!leading-[24px] xl:!leading-[29px]"><?php echo $start_date_display; ?> - <?php echo $end_date_display; ?></p>
                            <a href="<?php echo $selected_tournament_link; ?>" target="_blank" class="st-subtitle-caps text-light-blue text-nowrap underline truncate-text !text-[18px] md:!text-[32px] min-h-[46px]"><?php the_title(); ?></a><br>
                            <p class="st-subtitle text-blue text-nowrap truncate-text !text-[18px] md:!text-[32px]"><?php echo $selected_tournament_location; ?></p>
                            <?php
                ...
                if (!$tournament_found) :
                    ?>
                    <p class="st-body-dates text-blue !leading-[29px] md:!leading-[24px] xl:!leading-[29px]"><?php esc_html_e('-', 'stricker'); ?></p>
                    <a class="st-subtitle-caps text-light-blue text-nowrap !text-[18px] md:!text-[32px] min-h-[46px]"><?php esc_html_e('Kein aktuelles Turnier', 'stricker'); ?></a>
                    <p class="st-subtitle text-blue !text-[18px] md:!text-[32px]"><?php esc_html_e('-', 'stricker'); ?></p>
                <?php endif; ?>
                </div>
            </div>
            ...
            <div class="col-span-6 xl:col-span-2">
                ...
                if ($tournament_found) :
                    ...
                    ?>
                    <p class="st-body-dates text-blue !leading-[29px] md:!leading-[24px] xl:!leading-[29px]"><?php echo $start_date_display; ?> - <?php echo $end_date_display; ?></p>
                    <a href="<?php echo $selected_tournament_link; ?>" target="_blank" class="st-subtitle-caps text-light-blue text-nowrap truncate-text underline !text-[18px] md:!text-[32px]"><?php echo $selected_tournament_title; ?></a><br>
                    <p class="st-subtitle text-blue text-nowrap truncate-text !text-[18px] md:!text-[32px]"><?php echo $selected_tournament_location; ?></p>
                <?php else : ?>
                    <!-- If no tournament post with start date after today is found, display custom content -->
                    <p class="st-body-dates text-blue !leading-[29px] md:!leading-[24px] xl:!leading-[29px]"><?php esc_html_e('-', 'stricker'); ?></p>
                    <a class="st-subtitle-caps text-light-blue text-nowrap !text-[18px] md:!text-[32px] min-h-[46px]"><?php esc_html_e('Kein bevorstehendes Turnier', 'stricker'); ?></a>
                    <p class="st-subtitle text-blue !text-[18px] md:!text-[32px] min-h-[46px]"><?php esc_html_e('-', 'stricker'); ?></p>
                <?php endif; ?>
