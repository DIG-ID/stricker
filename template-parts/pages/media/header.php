<section class="page-header page-header__media bg-light-blue text-dark-blue pt-64 pb-40">
	<div class="st-grid">
		<div class="col-span-2 md:col-span-4 md:col-start-2 xl:col-span-3 xl:col-start-2">
			<?php do_action( 'breadcrumbs' ); ?>
			<h1 class="st-title text-dark-blue"><?php the_title(); ?></h1>
		</div>
		<div class="col-span-2 md:col-span-4 md:col-start-2 xl:col-span-2">
			<p class="font-transducer font-normal text-[17px] text-dark-blue leading-[29px] tracking-[0.34px]"><?php the_field( 'header_description' ); ?></p>
		</div>
		<div class="col-span-2 md:col-span-3 md:col-start-2 xl:col-span-4 xl:col-start-8">
			<div class="info border border-blue rounded-xl px-11 py-8">
				<p class="font-transducer font-normal text-[17px] text-blue leading-[29px] tracking-[0.34px] mb-7"><?php the_field( 'header_notification_text' ); ?></p>
				<p class="font-transducer font-semibold text-xs text-dark-blue leading-[23px] tracking-[0.24px] flex w-full gap-x-6">
					<span class="mt-1">
					...
					<?php the_field( 'header_notification_disclaimer' ); ?></p>
			</div>
		</div>
	</div>
</section>
