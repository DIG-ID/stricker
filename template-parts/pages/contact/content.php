	...
	<div class="st-grid !px-0">
		<div class="st-container st-container-grid">
			<div class="col-span-6	 md:col-span-6 xl:col-span-4">
				...
				if ( $management ) :
					?>
					<p class="flex items-center gap-x-6 font-transducerCondensed font-[340] tracking-wide xl:tracking-normal text-white text-base md:text-[45px] leading-none ml:leading-[50px] italic b-12 md:mb-32 xl:mb-11">
						<svg class="w-4 h-4 md:w-8 md:h-8" viewBox="0 0 271 249" fill="#14A5BB" xmlns="http://www.w3.org/2000/svg">
							...
							<path vector-effect="non-scaling-stroke" stroke="#14A5BB" stroke-width="1" stroke-linejoin="round" stroke-linecap="round" d="M135.22,129.25c-31.64,0-57.1-39.77-57.1-72.7S102.67.1,135.22.1s57.1,24.27,57.1,56.45-25.47,72.7-57.1,72.7ZM135.22,9.46c-27.22,0-47.75,20.25-47.75,47.09,0,28.51,22.04,63.34,47.75,63.34s47.74-34.83,47.74-63.34c0-26.84-20.52-47.09-47.74-47.09Z"/>
							<path vector-effect="non-scaling-stroke" stroke="#14A5BB" stroke-width="1" stroke-linejoin="round" stroke-linecap="round" d="M127.03,180.3c-1.93,0-3.64-1.16-4.36-2.97l-11.93-30.34c-.94-2.41.25-5.13,2.65-6.07.56-.22,1.14-.33,1.72-.33,1.93,0,3.65,1.17,4.35,2.98l10.9,27.71,10.21-.34,10.4-27.37c.72-1.81,2.43-2.98,4.36-2.98.59,0,1.17.11,1.71.33,1.17.46,2.08,1.34,2.59,2.49.49,1.15.52,2.42.06,3.58l-11.93,30.33c-.69,1.78-2.45,2.97-4.36,2.97h-16.37Z"/>
							<path vector-effect="non-scaling-stroke" stroke="#14A5BB" stroke-width="1" stroke-linejoin="round" stroke-linecap="round" d="M114.3,248.71c-2.53-.44-4.25-2.88-3.81-5.41l11.93-68.49c.39-2.24,2.32-3.87,4.61-3.87h16.37c2.28,0,4.23,1.63,4.62,3.87l11.92,68.49c.22,1.23-.05,2.47-.77,3.49-.73,1.03-1.8,1.71-3.03,1.93h-.19c-2.99,0-4.85-1.61-5.23-3.82l-11.33-65.04-8.87.44-10.81,64.61c-.4,2.25-2.33,3.88-4.61,3.88l-.81-.07Z"/>
