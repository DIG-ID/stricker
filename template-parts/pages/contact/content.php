	...
	<div class="st-container-notfluid">
		<div class="st-grid">
			<div class="col-span-4 col-start-2">
				...
				if ( $email ) :
					?>
					<p class="flex items-center gap-x-6 font-transducerCondensed font-[340] text-white text-[45px] leading-[50px] italic mb-11">
				...
				if ( $phone ) :
					?>
					<p class="flex items-center gap-x-6 font-transducerCondensed font-[340] text-white text-[45px] leading-[50px] italic">
						<svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
