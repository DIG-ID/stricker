	...
	<div class="st-grid">
		<div class="st-container st-container-grid">
			<div class="col-span-6	 md:col-span-6 xl:col-span-4">
				...
				if ( $phone ) :
					?>
					<p class="flex items-center gap-x-6 font-transducerCondensed font-[340] tracking-wide xl:tracking-normal text-white text-base md:text-[45px] leading-none md:leading-[50px] italic mb-16 md:mb-32 xl:mb-0">
						<svg class="w-4 h-4 md:w-8 md:h-8" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
